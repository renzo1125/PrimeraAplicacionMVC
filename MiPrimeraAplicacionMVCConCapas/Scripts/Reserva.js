 ...
 <div class="row" style="display:none">
          <div class="mb-3 col-md-3" >
            ...
            <div class="mb-3 col-md-3" >
                ...
                <input type="text" id="iidhabitacionreserva"
                      name="iidhabitacion" class="form-control o max-40 min-4"
...
function listarCalendario() {
    ...
    fetchGet("Reserva/listarReservaPorHabitacion/?iidhabitacion=" + iidhabitacion, function (data) {
